var CountUp = function(a, n, t, e, i, r) {
    ...
    if (o.version = function() {
            ...
            formattingFn: function(a) {
                var n, t, e, i, r, s, l = a < 0;
                if (a = Math.abs(a).toFixed(o.decimals), n = (a += "").split("."), t = n[0], e = n.length > 1 ? o.options.decimal + n[1] : "", o.options.useGrouping) {
                    for (i = "", r = 0, s = t.length; r < s; ++r) 0 !== r && r % 3 == 0 && (i = o.options.separator + i), i = t[s - r - 1] + i;
                    t = i
                }
                o.options.numerals.length && (t = t.replace(/[0-9]/g, function(a) {
                    return o.options.numerals[+a]
                }), e = e.replace(/[0-9]/g, function(a) {
                    return o.options.numerals[+a]
                }));
                return (l ? "-" : "") + o.options.prefix + t + e + o.options.suffix
            },
            prefix: "",
            suffix: "",
            numerals: []
        }, r && "object" == typeof r)
        for (var s in o.options) r.hasOwnProperty(s) && null !== r[s] && (o.options[s] = r[s]);
    "" === o.options.separator ? o.options.useGrouping = !1 : o.options.separator = "" + o.options.separator;
    for (var l = 0, u = ["webkit", "moz", "ms", "o"], m = 0; m < u.length && !window.requestAnimationFrame; ++m) window.requestAnimationFrame = window[u[m] + "RequestAnimationFrame"], window.cancelAnimationFrame = window[u[m] + "CancelAnimationFrame"] || window[u[m] + "CancelRequestAnimationFrame"];
    ...
    window.requestAnimationFrame || (window.requestAnimationFrame = function(a, n) {
        ...
        return !!o.initialized || (o.error = "", o.d = "string" == typeof a ? document.getElementById(a) : a, o.d ? (o.startVal = Number(n), o.endVal = Number(t), d(o.startVal) && d(o.endVal) ? (o.decimals = Math.max(0, e || 0), o.dec = Math.pow(10, o.decimals), o.duration = 1e3 * Number(i) || 2e3, o.countDown = o.startVal > o.endVal, o.frameVal = o.startVal, o.initialized = !0, !0) : (o.error = "[CountUp] startVal (" + n + ") or endVal (" + t + ") is not a number", !1)) : (o.error = "[CountUp] target is null or undefined", !1))
    }, o.printValue = function(a) {
        var n = o.options.formattingFn(a);
        "INPUT" === o.d.tagName ? this.d.value = n : "text" === o.d.tagName || "tspan" === o.d.tagName ? this.d.textContent = n : this.d.innerHTML = n
    }, o.count = function(a) {
        o.startTime || (o.startTime = a), o.timestamp = a;
        var n = a - o.startTime;
        ...
        o.initialize() && (d(a = Number(a)) ? (o.error = "", a !== o.frameVal && (cancelAnimationFrame(o.rAF), o.paused = !1, delete o.startTime, o.startVal = o.frameVal, o.endVal = a, o.countDown = o.startVal > o.endVal, o.rAF = requestAnimationFrame(o.count))) : o.error = "[CountUp] update() - new endVal is not a number: " + a)
