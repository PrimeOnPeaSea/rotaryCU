! function(r) {
    ...
    O.fn.attr2 = function() {
        ...
        "function" == typeof F ? F = {
            ...
            data: e,
            dataType: t
        }, "function" == typeof r && (F.success = r)) : void 0 === F && (F = {}), E = F.method || F.type || this.attr2("method"), r = (r = (r = "string" == typeof(t = F.url || this.attr2("action")) ? O.trim(t) : "") || window.location.href || "") && (r.match(/^([^#]+)/) || [])[1], t = /(MSIE|Trident)/.test(navigator.userAgent || "") && /^https/i.test(window.location.href || "") ? "javascript:false" : "about:blank", F = O.extend(!0, {
            url: r,
        ...
        r = {};
        if (this.trigger("form-pre-serialize", [this, F, r]), r.veto) return C("ajaxSubmit: submit vetoed via form-pre-serialize trigger"), this;
        ...
        if (F.data && (c = O.isFunction(F.data) ? F.data(a) : F.data, F.extraData = c, c = O.param(c, t)), F.beforeSubmit && !1 === F.beforeSubmit(a, this, F)) return C("ajaxSubmit: submit aborted via beforeSubmit callback"), this;
        if (this.trigger("form-submit-validate", [a, this, F, r]), r.veto) return C("ajaxSubmit: submit vetoed via form-submit-validate trigger"), this;
        r = O.param(a, t);
        c && (r = r ? r + "&" + c : c), "GET" === F.type.toUpperCase() ? (F.url += (0 <= F.url.indexOf("?") ? "&" : "?") + r, F.data = null) : F.data = r;
        var o, n, i, s = [];
        ...
        var u, t = 0 < O("input[type=file]:enabled", this).filter(function() {
                return "" !== O(this).val()
            }).length,
            c = "multipart/form-data",
            r = L.attr("enctype") === c || L.attr("encoding") === c,
            c = v.fileapi && v.formdata;
        C("fileAPI :" + c), !1 !== F.iframe && (F.iframe || (t || r) && !c) ? F.closeKeepAlive ? O.get(F.closeKeepAlive, function() {
            u = f(a)
        }) : u = f(a) : u = (t || r) && c ? function(e) {
