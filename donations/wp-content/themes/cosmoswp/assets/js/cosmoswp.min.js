! function(e) {
    ...
    e(document).on("focus", "#cwp-header-wrap .cwp-primary-menu-wrapper a", function(t) {
        ...
        e(this).next(".sub-menu").addClass("open"), e(this).parentsUntil(".cwp-primary-menu", "li .sub-menu").addClass("open")
        ...
        let s = !1;
        13 === e.which ? s = !0 : 9 === e.which && !0 === e.shiftKey && (s = !0), s && (e.preventDefault(), t())
    }), e(document).on("keydown", "#cwp-menu-icon-btn-text", function(t) {
        13 === t.which && (t.preventDefault(), e("body").addClass("cwp-show-menu-sidebar"), t.stopPropagation(), e(".cwp-close-btn").focus())
        ...
        9 === (t.keyCode || t.which) && s.addEventListener("focusout", t => {
            !s.contains(t.relatedTarget) && e(".cwp-search-dropdown").removeClass("is-active-dropdown")
        })
    })
}(jQuery), /(trident|msie)/i.test(navigator.userAgent) && document.getElementById && window.addEventListener && window.addEventListener("hashchange", function() {
    ...
    function k() {
        if (s.width() < 992)
            for (let t = 1; t <= 12; t++) e(".cwp-body-main-wrap .cwp-grid-column.grid-" + t + ", .cwp-dynamic-footer .cwp-grid-column.grid-" + t).removeClass("grid-" + t).addClass("grid-md-" + t)
    }

    function x() {
        s.scrollTop() > 250 ? (e(".cosmoswp-sticky").addClass("add-sticky"), e(".scrollup").show(), b.show()) : (e(".cosmoswp-sticky").removeClass("add-sticky"), e(".scrollup").hide(), b.hide())
    }
    void 0 !== e.fn.theiaStickySidebar && o.hasClass("add-sticky-sidebar") && e(".cwp-ms-content-grid-column").theiaStickySidebar(), n.find("li").each(function() {
            let t = e(this);
            t.children("ul.sub-menu").length && t.children("a").prepend('<i class="submenu-icon ' + v + '"></i>')
            ...
            a.toggleClass("open-footer"), h >= s.height() / 2 && (u.addClass("scroll-footer"), u.css("max-height", s.height() / 2), t = s.height() / 2, a.css("bottom", -t), e(".cwp-scrollbar-inner").scrollbar())
        }), y(), k(), x(), b.click(function(t) {
            e("body,html").animate({
                scrollTop: 0
        ...
        function() {
            let e = 40;
            o.hasClass("gutentor-active") && (e = 0), o.hasClass("cwp-overlay-fixed") && !o.hasClass("home") ? a.length && f.hasClass("cwp-header-sticky") ? g.css("padding-top", "") : a.length ? g.css("padding-top", "") : g.css("padding-top", m + e) : o.hasClass("cwp-overlay-transparent") && !o.hasClass("home") && (a.length ? g.css("padding-top", "") : g.css("padding-top", m + e))
        }(),
        function() {
            if (o.hasClass("cwp-masonry-blog")) {
                ...
                s.imagesLoaded(function() {
                    t.fadeIn("slow"), s.masonry({
                        itemSelector: ".cwp-blog-grid"
                    })
                }), t.show(), e(window).resize(function() {
    ...
    function E(t) {
        ...
        void 0 === I && null === I || (s = e(t).offset().top - D.height()), e("html, body").animate({
            scrollTop: s
        }, 800)
    }
    ...
    "" !== S && document.getElementById(S.substring(1, S.length)) && E(S), e("a").on("click", function(e) {
    ...
    }), C(), y(), c.on("click", "#search-icon", function(t) {
        ...
        let o = s.data("clicks");
        o ? (s.find(".cwp-open-icon").show(), s.find(".cwp-close-icon").hide()) : (s.find(".cwp-open-icon").hide(), s.find(".cwp-close-icon").show()), s.data("clicks", !o)
    }), i.hasClass("cwp-left-menu-push") && p.addClass("cwp-left-push"), i.hasClass("cwp-right-menu-push") && p.addClass("cwp-right-push"), c.on("click", "#cwp-menu-icon-btn-text", function(e) {
        e.preventDefault(), o.addClass("cwp-show-menu-sidebar"), e.stopPropagation()
    }), n.hasClass("cwp-offcanvas-left") && r.addClass("cwp-offcanvas-left-push"), n.hasClass("cwp-offcanvas-right") && r.addClass("cwp-offcanvas-right-push"), c.on("click", ".cwp-offcanvas-btn", function(e) {
    ...
    s.scroll(function() {
        ...
        void 0 === I && null === I || (z > t ? (B = !0, H = !1) : (H = !0, B = !1, M = t), B && Math.abs(M - _) > t && ("cwp-scroll-up-sticky" === I && (D.addClass("cwp-scroll-up-sticky"), "enable" === j && D.addClass("sticky-color")), 0 === t && ("cwp-scroll-up-sticky" === I ? D.removeClass("cwp-scroll-up-sticky") : "cwp-scroll-down-sticky" === I && D.removeClass("cwp-scroll-down-sticky"), D.removeClass("sticky-color"))), H && t > _ && "cwp-scroll-down-sticky" === I && (D.addClass("cwp-scroll-down-sticky"), "enable" === j && D.addClass("sticky-color")), z = t), t >= 100 ? "normal" === I && "enable" === j && D.addClass("sticky-color") : D.removeClass("sticky-color"),
            function() {
                let t = s.scrollTop();
                o.hasClass("admin-bar") && s.width() < 768 && (t > 0 ? e(".cwp-header-sticky").css("top", "0") : e(".cwp-header-sticky").css("top", ""))
            }()
    });
    let $ = e(".cwp-sidebar"),
        L = $.data("widget-title"),
    ...
    O(q, "widget-title", F), O(q, "widget", J), U.each(function() {
        let t = e(this);
        (t.hasClass("cwp-text-left") || t.hasClass("cwp-text-right") || t.hasClass("cwp-text-center")) && (t.find(".widget").removeClass("cwp-text-left cwp-text-right cwp-text-center"), t.find(".widget-title").removeClass("cwp-text-left cwp-text-right cwp-text-center"))
    }), s.resize(function() {
        y(), C(), k()
    ...
    }), void 0 !== e.fn.webTicker && e("#webTicker").show().webTicker({
        startEmpty: !1,
        hoverpause: !0,
        direction: "left",
        transition: "linear"
    ...
    if (c.on("click", ".cwp-ajax-show-more", function(t) {
            t.preventDefault();
            let s = e(this),
                o = s.attr("data-click"),
                c = parseInt(s.attr("data-number"));
            return V - 1 >= W && s.html(cosmoswp.no_more_posts), !(0 === o || V - 1 >= W) && (s.html("<img src=" + cosmoswp.loadMoreGif + " alt=”animated” />"), s.attr("data-click", 0), e("#cwp-ajax-temp-post").load(X + " .cwp-article-ajax", function() {
                V++, X = X.replace(/(\/?)page(\/|d=)[0-9]+/, "$1page$2" + V);
                let t = e("#cwp-ajax-temp-post"),
                    o = t.html();
                t.html("");
                let a = e(o).filter(".cwp-article-ajax");
                e(".cwp-blog-grid-row").append(a), s.attr("data-number", c + 1), s.attr("data-click", 1), s.html(cosmoswp.show_more)
            }), !1)
        }), "auto-ajax" === cosmoswp.pagination_option) {
        let t = e("body #cwp-main");
        s.scroll(function() {
            let o = t.offset();
            s.scrollTop() + s.height() > t.scrollTop() + t.height() + o.top && e(".cwp-ajax-show-more").trigger("click")
        })
    }! function() {
        let t = e(".cwp-woo-view-switcher"),
            s = e(".cosmoswp-woo-archive-grid-row");
        t.on("click", ".cwp-trigger-grid", function() {
            s.addClass("cwp-grid"), s.removeClass("cwp-list"), e(this).siblings().removeClass("active"), e(this).addClass("active")
        }), t.on("click", ".cwp-trigger-list", function() {
            s.addClass("cwp-list"), s.removeClass("cwp-grid"), e(this).siblings().removeClass("active"), e(this).addClass("active")
        })
    }(),
    function() {
        let t = e(".cwp-edd-view-switcher"),
            s = e(".cosmoswp-edd-grid-row");
        s.hasClass("cwp-grid") && e(".cwp-trigger-grid").addClass("active"), t.on("click load", ".cwp-trigger-grid", function(t) {
            t.preventDefault(), s.addClass("cwp-grid"), s.removeClass("cwp-list"), e(this).siblings().removeClass("active"), e(this).addClass("active")
        }), t.on("click", ".cwp-trigger-list", function(t) {
            t.preventDefault(), s.addClass("cwp-list"), s.removeClass("cwp-grid"), e(this).siblings().removeClass("active"), e(this).addClass("active")
        })
